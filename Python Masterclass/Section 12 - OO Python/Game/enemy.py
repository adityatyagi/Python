...
class Enemy:
    ...
    def take_damage(self, damage):
        ...
        if remaining_points >= 0:
            ...
            print('I took {} damage and I have {} left'.format(damage, self._hit_points))
        else:
            self._lives -= 1
            if self._lives > 0:
...
class Troll(Enemy):
    ...
    def __init__(self, name):
        ''' Different ways of calling the init method of the base/supeclass '''
    ...
    def grunt(self):
        print('I am {0._name}. {0._name} kills you!!'.format(self))


class Vampyre(Enemy):

    def __init__(self, name='Basic Vampyre'):
