...
cards = []
load_images(cards)
# print(cards)      ->> prints the cards, to check if the cards being loaded or not 
...
if __name__ == "__main__": # with this we can actually import the blackjack code as a module in another .py file and not run i, automatically
    play()
