...
if __name__ == '__main__':
    ...
    ''' in composition, if we delete the my_page, the structure of the program will break.
        in composition, the references are made inside the HtmlDoc() using Body(), Head(), Doctype() '''
    ...
    # in aggregation, the three objects will exist even if my_page is deleted.
    # these objects are created independently abd then a new object is created by these calling
    # the constructor of HtmlDoc()
