...
rbValue.set(2) # preselected option for the radio buttons
...
radio2.grid(row=1, column=0, sticky="w") # by default, this will be selected, because rbValue = 2 on L-48
...
# Time spinners - Held by timeFrame
